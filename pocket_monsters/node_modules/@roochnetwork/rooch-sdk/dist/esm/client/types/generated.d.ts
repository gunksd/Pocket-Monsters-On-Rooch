...
export type AnnotatedMoveValueView = number | string | string | boolean | string | AnnotatedMoveValueView[] | string | AnnotatedMoveStructView | SpecificStructView | number | number | string;
...
export type VMStatusView = 'Executed' | {
    MoveAbort: {
        abort_code: string;
        location: string;
    };
