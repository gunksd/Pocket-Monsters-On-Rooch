...
var clientProvider_exports = {};
__export(clientProvider_exports, {
  ClientContext: () => ClientContext,
  RoochClientProvider: () => RoochClientProvider
});
module.exports = __toCommonJS(clientProvider_exports);
...
var HTTPTransport = class extends import_rooch_sdk8.RoochHTTPTransport {
  ...
  async request(input) {
    ...
    try {
      ...
      if ("code" in e && (e.code === import_rooch_sdk8.ErrorValidateInvalidAccountAuthKey || e.code === import_rooch_sdk8.ErrorValidateSessionIsExpired)) {
...
var ClientContext = (0, import_react9.createContext)(null);
...
var DEFAULT_CREATE_CLIENT = function createClient(_name, config, setCurrentSession) {
  if ((0, import_rooch_sdk9.isRoochClient)(config)) {
    return config;
  }
  ...
  return new import_rooch_sdk9.RoochClient(config);
};
function RoochClientProvider(props) {
  ...
  const clearSession = (0, import_react8.useCallback)(() => {
    try {
  ...
  const ctx = (0, import_react9.useMemo)(() => {
    return {
      ...
      networks,
      config: networks[currentNetwork] instanceof import_rooch_sdk9.RoochClient ? null : networks[currentNetwork],
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(ClientContext.Provider, { value: ctx, children });
}
