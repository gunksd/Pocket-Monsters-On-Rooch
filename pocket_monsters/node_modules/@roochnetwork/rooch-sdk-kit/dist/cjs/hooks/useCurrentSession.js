...
var useCurrentSession_exports = {};
__export(useCurrentSession_exports, {
  useCurrentSession: () => useCurrentSession
});
module.exports = __toCommonJS(useCurrentSession_exports);
...
function useSessionStore(selector) {
  const store = (0, import_react9.useContext)(RoochContext);
  if (!store) {
    throw new Error(
