...
import { createContext as createContext3, useRef as useRef2 } from "react";
...
import { useCallback, createContext, useEffect as useEffect2, useRef } from "react";
...
import { Session as Session2 } from "@roochnetwork/rooch-sdk";
    ...
    persist2(
      ...
      }),
      {
        ...
        storage: createJSONStorage2(() => storage, {
          reviver: (key, value) => {
            if (key === "sessions") {
              return value.map((session) => Session2.fromJson(session));
            }
            return value;
          }
        }),
...
function RoochProvider(props) {
  ...
  return /* @__PURE__ */ jsx3(RoochContext.Provider, { value: storeRef.current, children: /* @__PURE__ */ jsx3(RoochClientProvider, { networks, defaultNetwork, children }) });
}
export {
  RoochContext,
  RoochProvider
